...
%Imaging was performed by LSM using LCI Plan Neofluar 63$\times$/1.3 Imm Corr DIC and Plan Apochromat 100$\times$/1.4 Oil Ph3 objective lenses.
...
%Notes:
%\begin{itemize}
%	\item Pictures of the samples? Who has it?
%	\item 3 expanded samples? IIRC there were 2 samples only.
%	\item 4 non expanded controls? Why?
%	\item Identify files
%	\item What should be compared here?
%\end{itemize}

%\begin{figure}[h!]
%\centering
%\includegraphics[width=.5\columnwidth]{Exp_5_Expansion/Figures/trape}
%\caption{Matrix expansion} % The text in the square bracket is the caption for the list of figures while the text in the curly brackets is the figure caption
%\label{fig:trape}
%\end{figure}
%
%\begin{table}[hbt]
...
%\begin{tabular}{cllc}
%\toprule
%		 	& \thead{Pre-Expansion\\(cm)} & \thead{Post-Expansion\\(cm)} & Factor\\
%\midrule
%Sample 1	&\thead[l]{a: 0.45\\b: 0.6\\h: 0.75\\Area: 0.39}&\thead[l]{A: 1.5\\B: 2.7\\H: 3.3\\Area: 6.93}& \texttildelow4.2\\
%Sample 1	&\thead[l]{a: 0.65\\b: 0.8\\h: 0.75\\Area: 0.54}&\thead[l]{A: 2.5\\B: 3.4\\H: 3.4\\Area: 10.03}& \texttildelow4.3\\		
%\bottomrule
%\end{tabular}
%\label{tab:matarea}
%\end{table}
...
%\begin{itemize}
%\item CP224 is a protein on the corona of the centrosome, donut shaped, larger than CP91. labelled by antibodies conjugated with Alexa488 (should be seen as green).
%\item CP91 is a protein at the core of the centrosome. lablled by antibodies conjugated with Alexa568 (should appear red).
%\item nucleus is labelled by DAPI. 
%\item CP91 (centrosome core) labelled by AlexaFluor568 (magenta) and CP224 (centrosome corona) by AlexaFluor488 (green)
%\item the green sticks to the + end of microtubules.
%\item have two expanded samples, one has shift of red spot toward the upper right relatively to the green: could be optical problem or gel moving (because still wet during imaging --> obj contacts the sample/coverslip through immersion oil). The other sample was uneven.
%\end{itemize}
